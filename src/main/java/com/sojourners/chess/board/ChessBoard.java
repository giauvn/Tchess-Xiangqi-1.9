...
public class ChessBoard {
    ...
    /**
     * Notation (recording the moves of a game)
     * @param move
     * @return
     */
    ...
    /**
     * Translation Engine Moves (Thinking Details)
     * @param moveList
     * @return
     */
