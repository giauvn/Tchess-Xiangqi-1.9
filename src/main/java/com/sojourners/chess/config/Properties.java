...
public class Properties implements Serializable {
    ...
    /*
     * Move hint color. Use a wrapper type to preserve transparency, ensuring compatibility when reading legacy serialized configurations.
     * Able to distinguish between "unconfigured" and 0% transparency explicitly selected by the user.
     */
